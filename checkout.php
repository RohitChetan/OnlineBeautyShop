...
if(isset($_POST['submit'])){
	...
	if($payment_type=='instamojo'){
		...
		if(isset($response->payment_request->id)){
			...
			if (isset($response->message)) {
				...
				if (is_array($response->message)) {
					...
					// Handle the case where $response->message is not an array
					$errMsg .= strtoupper('message') . ' : ' . $response->message . '<br/>';
				}
		...
		<script>
			...
			"image": "https://expertisement.com/images/Expertisement.png",
			"handler": function (response) {
				...
				$.ajax({
					...
					type: "POST",
					data: { product_id: OrderId, payment_id: paymentid, payment_Status:paymentStatus  },
										...
										<div class="accordion__body">
											<div class="paymentinfo">
												<div class="single-method">
													...
													&nbsp;&nbsp;Razorpay <input type="radio" name="payment_type" value="razorpay" required/>
												</div>
												<div class="single-method">
...
$qty=$val1['qty'];	
                            ...
                            <div class="ordre-details__total">
								...
								<input type="text" id="order_alloverprice" value="<?php echo $cart_total?>">
                            </div>
