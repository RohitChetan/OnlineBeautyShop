         ...
         <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
				  ...
				  <li class="menu-item-has-children dropdown">
                     <a href="banner.php" > Main Banner</a>
                  </li>

                  <li class="menu-item-has-children dropdown">
                     <a href="all_pages_banner.php" > Pages Banner</a>
                  </li>
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="http://localhost/Shivu_Ecom/index.php"><img src="images/logo.png" alt="Logo" style="max-width:55px !important;"></a>
                  <a class="navbar-brand hidden" href="http://localhost/Shivu_Ecom/index.php"><img src="images/logo2.png" alt="Logo"></a>
